...
## Part VI-B — Data Extracted from Downloaded Academic Papers (April 2026)

This section records quantitative findings extracted from the 7 PDFs processed in session. Used for in-text citation in the essay — cite original paper, not this file.

---

### From Bjerkan, Nørbech & Nordtømme (2016) — Norway BEV incentive survey (n=3,342)

| Finding | Value | Notes |
|---------|-------|-------|
| Norway BEV market share (2015) | ~17.6% of new registrations | Stated in paper as milestone at time of publication |
| Top purchase driver | Total cost of ownership / purchase price | Ranked #1 by BEV buyers |
| Second driver | Operating cost savings | Lower fuel + maintenance |
| Third driver | Non-financial road-use benefits | Bus lane, toll, ferry, parking |
| VAT on cars in Norway | 25% | Exempted for EVs — equivalent to significant price reduction |
| Registration tax | Proportional to CO₂/NOx emissions | EVs fully exempt; equivalent to ~50% of pre-tax ICE price for mid-size car |
| Policy tenure | Incentive package stable since mid-1990s | Cross-party political commitment cited as key |

**Essay use:** Barrier 1 (price premium removal via tax exemption, not scrappage). Barrier 3 (effective affordability improvement via fiscal mechanism). Citation: Bjerkan et al. (2016).

---

### From Sierzchula et al. (2014) — 30-country OLS regression

| Finding | Value | Notes |
|---------|-------|-------|
| Countries in sample | 30 | Australia, Belgium, Canada, China, Croatia, Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Iceland, Ireland, Israel, Italy, Japan, Netherlands, NZ, Norway, Poland, Portugal, Slovenia, Spain, Sweden, Switzerland, Turkey, UK, US (2012 data) |
| Dependent variable | Log(EV market share) | Logit-transformed proportion of new car sales |
| Adjusted R² (full model) | 0.623 | 62.3% of cross-national variation explained |
| Financial incentives coefficient | β = 0.357 (unstandardized), p = 0.039* | +$1,000 in incentives → +0.06% market share, holding other variables constant |
| Charging infrastructure Beta | β = 0.599 (standardized), p = 0.004** | **Stronger predictor than financial incentives** |
| Adjusted R² without charging infrastructure | 0.533 | Dropping charging drops model from 62.3% to 53.3% explained variance |
| Adjusted R² without financial incentives | 0.391 | Dropping incentives drops model to 39.1% — larger impact |
| Adjusted R² without both | 0.238 | Both together necessary |
| Country-specific factors | HQ (local EV manufacturing) positive, p = 0.079+ | Estonia, Belgium outliers — government bulk purchases explained by country context |
| Income, education, environmentalism | Not significant | Socio-demographic variables do not predict adoption at national level |
| Policy implication | Charging infra + financial incentives must complement each other | Neither alone is sufficient; combination required |

**Essay use:** Barrier 2 (charging infrastructure is the stronger predictor) and Barrier 3 (financial incentives matter but less so at national level; local charging access more predictive). The adjusted R² decomposition is the key figure: cite as "removing charging infrastructure from the model reduces its explanatory power by 9 percentage points." Citation: Sierzchula et al. (2014).

---

### From Kester et al. (2018) — Nordic expert interviews (n=257 respondents, 227 interviews)

| Finding | Value | Notes |
|---------|-------|-------|
| Total interviews | 227 | 5 Nordic countries, 17 cities, Sept 2016 – May 2017 |
| Respondents | 257 | 201 institutions; transport, energy, government, research, industry sectors |
| Country breakdown | Norway 61, Finland 50, Denmark 45, Sweden 42, Iceland 29 | Norway most represented |
| Cost Focus (subsidy/tax) mentioned | 59% of all interviews | #1 mechanism overall |
| Infrastructure Focus mentioned | 37% of interviews | #2 mechanism |
| Governance Focus (stability/long-term planning) | 47% of interviews | Critical governance principle |
| Information & Awareness | 28% of interviews | Systematically underemphasized |
| Norway: Continue existing policies | 70% of Norwegian experts | Norway alone argues against reducing incentives |
| Secondary benefits (HOV, parking, toll) | 37% of interviews overall | Context-dependent; EU rules constrain outside Norway |
| Cost Focus breakdown: subsidize EV price | 43% of total | Direct price reduction |
| Cost Focus breakdown: tax related | 29% of total | VAT, registration, annual tax |
| Policy instability risk | Denmark VAT exemption phase-out case cited | Market collapse after incentive withdrawal |
| Company fleet EV | Mentioned in Sweden, Denmark, Finland | Tax-efficient fleet leasing programs as adoption pathway |
| Phase-out of incentives | 19% of interviews | Must be planned — Norway debate on graceful exit |

**Essay use:** Three direct applications: (1) Cost primacy (59%) supports Barrier 3 financing argument — Chile's lack of fiscal price reduction is the most recommended intervention. (2) Policy stability finding directly argues against temporary or pilot programs; Chile's Law 21.505 must be extended credibly. (3) The Norway phase-out discussion (70% want continuation) shows that premature incentive removal collapses adoption — relevant to Chile's "don't start then stop" policy design. Citation: Kester et al. (2018).

---

### From Hardman (2019) — Review of non-financial/reoccurring incentives (41 studies)

| Incentive Type | Studies Reviewed | Studies Finding Positive Effect | % Finding Positive |
|----------------|-----------------|----------------------------------|-------------------|
| HOV/Bus/Rapid Transit Lane Access | 30 | 23 | 77% |
| Charging Infrastructure Development | 28 | 28 | **100%** |
| Parking Incentives (free/discounted) | 20 | 18 | 90% |
| Toll/Road Charge Exemptions | 10 | 7 | 70% |
| Annual/Circulation Tax Reductions | 4 | 4 | 100% |
| Vehicle Licensing Incentives (China) | 5 | 5 | 100% |

| Additional Finding | Value | Notes |
|--------------------|-------|-------|
| Most universally supported incentive | Charging infrastructure (28/28) | Universal positive across all study designs |
| HOV lane: Norway vs. US context | Effective in Norway; mixed in US (California) | Congestion level determines effectiveness |
| Free parking: best context | Urban, parking-scarce areas | Less effective where parking abundant |
| Norway toll exemptions | Among most-valued reoccurring incentives (Bjerkan 2016) | Ranked #1 reoccurring benefit by actual owners |
| China licensing plate benefit | Free plate in Shanghai = US$12,434 saving | 64% of buyers cited as most important factor |
| Charging infrastructure causality | Unclear direction (chicken-and-egg) | Both "more EVs drive more chargers" and "more chargers drive more EVs" |
| Norway policy mix in 2017 | VAT exempt + reg tax exempt + bus lanes + toll exempt + free ferries + free parking + charging network | Norway = 40% market share 2017 |

**Essay use:** (1) Barrier 2: 28/28 studies confirm charging infrastructure positively associated with adoption — the strongest evidence base across all incentive types. (2) Chile's non-financial incentive gap: Chile currently offers only circulation permit exemption (no HOV, no toll, no parking). This table documents that Chile is using fewer than 1 of 6 incentive types while Norway deploys all 6. (3) China licensing model: the free license plate mechanism (studied, 5/5 positive) confirms that reducing transaction costs beyond price matters — relevant to Barrier 3. Citation: Hardman (2019).

---

### From Noel et al. (2019, ERSS) — Range anxiety rhetoric analysis

| Finding | Value | Notes |
|---------|-------|-------|
| Newspaper articles analyzed | 1,020 | Norwegian press 2010–2017 |
| % of range anxiety discourse from non-EV sources | 74% | Media + ICE industry |
| EV owner range concern (post-purchase) | Very low | Sharp drop vs. pre-purchase concerns |
| Time to comfort with range | 2–3 months | Typical for new EV owners |
| Implication for infrastructure | Visible chargers reduce perceived anxiety even at low utilization | Symbolic infrastructure value |

**Essay use:** Barrier 2 behavioral framing. Shows that Chile's sparse regional charger presence amplifies *perceived* range anxiety for potential buyers outside Santiago, even if most daily trips do not require dense infrastructure. Citation: Noel et al. (2019).

---

### From de la Torre et al. (2024) — Santiago EV routing optimization

| Finding | Value | Notes |
|---------|-------|-------|
| Santiago macro-areas modeled | 7 | CEN, NOR, ORI, SOR, SUR, PON, EXT |
| Largest inter-area trip volume | ORI→ORI: 1,286,232 vehicles/day | Predominantly intra-area commuting |
| Chile electricity tariff scheme | Net billing (not net metering) | Injection rate < consumption rate |
| Profit impact of charger availability | Up to 2% difference | Between zero public chargers and saturated public charger scenario |
| Optimal charger placement | Better placement > more chargers | Same total chargers, redistributed → higher system efficiency |
| Chile 2035 ZEV target confirmed | 100% new light/medium vehicle sales | Referenced from Chilean National Electromobility Strategy 2021 |
| Chile 2050 zero-emission fleet target | ≥60% of entire vehicle park | Referenced from Chilean Decarbonization National Plan 2023 |

**Essay use:** Barrier 2 (charging geography). Net billing creates economic friction beyond infrastructure access. Optimal charger placement argument directly supports Netherlands demand-led model recommendation. Citation: de la Torre et al. (2024).

---

### From Arowolo & Perez (2026) — 15-country developing-country e-mobility patterns

| Finding | Value | Notes |
|---------|-------|-------|
| Countries analyzed | 15 | Including Chile, Colombia, Argentina, Brazil, China, India, Poland, Romania, Turkey, Philippines, Ecuador, Peru, Nicaragua, El Salvador, Guatemala |
| Chile power market classification | Model 3+ (wholesale + retail + peer-to-peer innovation) | Highest reform tier among LatAm countries |
| Chile decarbonisation potential | HIGH | With policy support |
| Chile digitalisation potential | HIGH | |
| Chile's dominant e-mobility investment pattern | **Electric buses** | Not private EVs |
| Argentina/Colombia pattern | Also electric buses, less developed than Chile | Same LatAm cluster |
| Eastern Europe (Poland, Romania, Turkey) | Private EVs | Different investment pattern |
| LatAm pattern finding | Chile, Colombia, Argentina cluster around public transport electrification | Pattern identified across 15 countries |
| Key investment barrier identified | Charging infrastructure gaps + financing constraints | Consistent with essay's 3-barrier framework |
| Central American countries | Low-cost 2/3-wheelers dominant | Small power system threshold effect |

**Essay use:** Most recent academic source (2026) directly confirming the public/private asymmetry as the central diagnostic the essay addresses. Use in Introduction (Chile's bus leadership vs. private EV lag) and in Conclusion (essay extends Arowolo & Perez by prescribing the policy mechanisms to close the gap). Citation: Arowolo & Perez (2026).

---

### From Martínez-Gómez & Espinoza (2024) — LatAm EV charging infrastructure survey

| Country | Public Charging Points | Notes |
|---------|----------------------|-------|
| Brazil | 3,800 | Most in São Paulo, Santa Catarina, Paraná |
| Mexico | 2,083 | |
| Colombia | 480 | |
| **Chile** | **1,032** | **SECconfirmed; 4th largest in LatAm** |
| Ecuador | ~130 | |
| Argentina | ~398 | |
| Uruguay | ~150 | |
| Costa Rica | ~440 | |

| Chile Charging Breakdown | Count | Share |
|--------------------------|-------|-------|
| Semi-fast | 405 | 39.2% |
| Fast | 194 | 18.8% |
| Ultra-fast | 18 | 1.7% |
| Slow | 2 | 0.2% |
| Type 2 connectors | 329 | — |
| Combo T2 (CCS) | 79 | — |
| CHAdeMO | 75 | — |
| Type 1 | 35 | — |
| GB/T DC | 5 | — |

| Key Geographic Finding | Value | Notes |
|------------------------|-------|-------|
| Chile geographic challenge | Extreme N-S length + Andes range | Makes inter-city fast-charge corridors technically/economically difficult |
| Challenge shared with | Argentina, Brazil | For cross-country connectivity |
| Green routes | Not yet established | No continuous N-S fast-charge corridor as of 2024 |
| Planned corridor | Descon: N-to-central Chile intelligent route | In development |
| EV sales growth Chile (Jan-Apr 2023) | +17% cumulative | Consistent with annual growth trend |
| LatAm combined HEV+PHEV+BEV growth | +260%+ in representative countries over 2021-2023 | Region-wide acceleration |

**Essay use:** Provides the most precise and citeable figure for Chile's total charging infrastructure (1,032 points, from SEC Chile / Electromaps as of mid-2024). Use in Barrier 2 to establish the baseline and geographic distribution problem. The geographic corridor challenge is direct academic evidence for why Santiago concentrates charging — the Andes and Chile's 4,300 km length impose structural costs on regional deployment that demand active government routing policy. The LatAm comparison (Chile #4 by absolute count, but #2 or #1 per capita relative to EV fleet) contextualizes Chile's relative achievement. Citation: Martínez-Gómez & Espinoza (2024).
